...
Realizamos una aplicación que facilite el explorado interactivo de las relaciones entre distintas medidas corporales. Ésta, permite que el usuario explore los datos haciendo uso de filtros, y realice gráficos seleccionando variables de interés, permitiendo también filtrar los datos por género para detectar patrones de dimorfismo sexual.
